 ...
 */
        ...
        713: (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
            "use strict";
            var _modules_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(627);
            var inputmask_dist_inputmask_min_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(125);
            function inputmaslFirstInit() {
                const inputMasks = document.querySelectorAll("[data-inputmask]");
                if (inputMasks.length) _modules_js__WEBPACK_IMPORTED_MODULE_0__.B.inputmask = Inputmask({
                ...
                pincodeInputs.length ? pincodeInputs.forEach((pincodeInput => {
                    ...
                    new Inputmask({
                        ...
                        oncomplete: function() {
                            ...
                            if (form && this.hasAttribute("data-oncomplete-formsent")) form.submit();
                            if (callback && callback.trim !== "") eval(callback);
                        }
                    }).mask(pincodeInput);
                })) : null;
            }
    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector("[data-toggle-menu]")) document.addEventListener("click", (function(e) {
        ...
        var modules = __webpack_require__(627);
        class Popup {
            constructor(options) {
                let config = {
                    logging: false,
            ...
            eventsPopup() {
                document.addEventListener("click", function(e) {
                    ...
                    if (this.targetOpen.element && !this.targetOpen.element.hasAttribute("data-noclose")) {
                        if (buttonClose || !e.target.closest(`.${this.options.classes.popupContent}`) && this.isOpen) {
                            e.preventDefault();
                            this.close();
                            return;
                        }
                    } else if (buttonClose && this.isOpen) {
                        e.preventDefault();
                        this.close();
                        return;
                    }
                ...
                document.addEventListener("keydown", function(e) {
                    if (this.options.closeEsc && e.which == 27 && e.code === "Escape" && this.isOpen) if (this.targetOpen.element && !this.targetOpen.element.hasAttribute("data-noclose")) {
                        e.preventDefault();
                        this.close();
                        return;
                    }
                ...
                setTimeout((() => {
                    ...
                    if (modules.B.select) {
                        ...
                        if (selects.length) for (let index = 0; index < selects.length; index++) {
                            ...
                            modules.B.select.selectBuild(select);
                        }
                    }
                }), 0);
            },
            ...
            function formSent(form, responseResult = ``) {
                ...
                setTimeout((() => {
                    if (modules.B.popup) {
                        ...
                        popup ? modules.B.popup.open(popup) : null;
                    }
                }), 0);
                formValidate.formClean(form);
        ...
        modules.B.select = new SelectConstructor({});
        ...
        modules.B.tippy = tippy_esm("[data-tippy-content]", {});
        ...
        document.addEventListener("formSent", (e => {
            ...
            if (form.closest("#authPopup") && success) {
                ...
                modules.B.popup.open("#pinPopup");
                const authPopupLinks = document.querySelectorAll('[data-popup="#authPopup"]');
                if (authPopupLinks) authPopupLinks.forEach((authPopupLink => {
                ...
                newCodeButton ? newCodeButton.addEventListener("click", (e => {
                    pinCodeTimer ? setPinCodeTimer(pinCodeTimer.dataset.timer, pinCodeTimer) : null;
                })) : null;
            }
        ...
        function cityChangeActions(citychange) {
            ...
            citylinks.forEach((citylink => {
                citylink.addEventListener("click", (e => {
                    ...
                    spollerTrigger.querySelector("span") ? spollerTrigger.querySelector("span").innerHTML = city : spollerTrigger.innerHTML = city;
                    cityoutput.innerHTML = number;
                    cityoutput.setAttribute("href", `tel:${numberRedacted}`);
                    spollerTrigger.click();
                    citylinks.forEach((citylink => {
                        citylink.hidden = false;
                    }));
        ...
        function setPinCodeTimer(seconds, pinCodeTimer) {
            ...
            document.addEventListener("beforePopupClose", (e => {
                if (e.detail.popup.targetOpen.element.contains(pinCodeTimer)) typeof interval !== "undefined" ? clearInterval(interval) : null;
            }));
        }
        function subMenuActions(middleSubMenuParents, middleSubMenuChildrens) {
            middleSubMenuParents.forEach((middleSubMenuParent => {
                ...
                middleSubMenuParent.addEventListener("mouseleave", (e => {
                    if (children) children.classList.remove("_active");
            ...
            middleSubMenuChildrens.forEach((middleSubMenuChildren => {
                ...
                middleSubMenuChildren.addEventListener("mouseenter", (e => {
                    if (children) children.closest("[data-middlesubmenu-children]") ? children.closest("[data-middlesubmenu-children]").classList.add("_active") : children.classList.add("_active");
                    middleSubMenuChildren.classList.add("_active");
                }));
                middleSubMenuChildren.addEventListener("mouseleave", (e => {
                    if (children) children.closest("[data-middlesubmenu-children]") ? children.closest("[data-middlesubmenu-children]").classList.remove("_active") : children.classList.remove("_active");
            ...
            if (submenuTriggers) {
                ...
                back.addEventListener("click", (e => {
                    if (lastOpened) {
                        ...
                        if (lastOpened === null) back.hidden = true;
                    } else {
                    ...
                    if (lastStyled && lastStyled !== mainList) {
                        ...
                        if (lastStyled === null) mainList.style = "";
                    } else mainList.style = "";
                }));
            }
        }
